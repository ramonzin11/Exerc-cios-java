...
public class MenuDeRestaurante {
    public static void main(String[] args) {
        ...
        String nomeDoPrato01 = "MACARRÃO COM MOLHO BRANCO";
        ...
        String nomeDoPrato05 = "CAMARÃO COM MOLHO";
        ...
        while (!sairDoLoop) {
            ...
            switch (interacaoDoUsuario) {
                case 1:
                    System.out.println("NOME DO PRATO: " + nomeDoPrato01 + " | VALOR DO PRATO: R$" + valorDoPrato01);
                    break;
                case 2:
                    System.out.println("NOME DO PRATO: " + nomeDoPrato02 + " | VALOR DO PRATO: R$" + valorDoPrato02);
                    break;
                case 3:
                    System.out.println("NOME DO PRATO: " + nomeDoPrato03 + " | VALOR DO PRATO: R$" + valorDoPrato03);
                    break;
                case 4:
                    System.out.println("NOME DO PRATO: " + nomeDoPrato04 + " | VALOR DO PRATO: R$" + valorDoPrato04);
                    break;
                case 5:
                    System.out.println("NOME DO PRATO: " + nomeDoPrato05 + " | VALOR DO PRATO: R$" + valorDoPrato05);
                    break; // Faltava este break
                case 0: // Faltava o case para sair do loop
                    sairDoLoop = true;
                    break;
                default:
